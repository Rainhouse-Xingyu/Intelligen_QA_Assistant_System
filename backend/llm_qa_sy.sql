...
CREATE TABLE `kb_qa_entry` (
  ...
  `category_id` bigint(20) DEFAULT NULL COMMENT '三级分类ID(kb_category.id)',
  `category_l1_id` bigint(20) DEFAULT NULL COMMENT '一级分类ID',
  `category_l2_id` bigint(20) DEFAULT NULL COMMENT '二级分类ID',
  `category_l3_id` bigint(20) DEFAULT NULL COMMENT '三级分类ID',
  `category_l1_name` varchar(100) DEFAULT NULL COMMENT '一级分类名称快照',
  `category_l2_name` varchar(100) DEFAULT NULL COMMENT '二级分类名称快照',
  `category_l3_name` varchar(100) DEFAULT NULL COMMENT '三级分类名称快照',
  `question` varchar(500) NOT NULL COMMENT '标准问题',
  `answer` text NOT NULL COMMENT '标准答案',
  `template_id` bigint(20) DEFAULT NULL COMMENT '回答模板ID',
  `template_code` varchar(50) DEFAULT NULL COMMENT '回答模板编码',
  ...
  `source_title` varchar(200) DEFAULT NULL COMMENT '来源标题快照',
  `source_url` varchar(500) DEFAULT NULL COMMENT '来源网址快照',
  ...
  KEY `idx_category_path` (`category_l1_id`, `category_l2_id`, `category_l3_id`)
...
DROP TABLE IF EXISTS `kb_answer_template`;
CREATE TABLE `kb_answer_template` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
DROP TABLE IF EXISTS `kb_source_reference`;
...
DROP TABLE IF EXISTS `kb_qa_source_ref`;
CREATE TABLE `kb_qa_source_ref` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
DROP TABLE IF EXISTS `hot_question_config`;
CREATE TABLE `hot_question_config` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
